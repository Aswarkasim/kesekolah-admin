                ...
                <form action="<?= base_url($edit . $user->id_user) ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="namalengkap" value="<?= $user->namalengkap ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nohp" value="<?= $user->nohp ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="no_ktp" value="<?= $user->no_ktp ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="latitude" value="<?= $user->latitude ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="longtitude" value="<?= $user->longtitude ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="role" class="form-control" required>class="form-control">
                                    <option value="none">--Role--</option>
                                    <option value="user" <?php if ($user->role == "user") {
                                                                echo "selected";
                                                            } ?>>user</option>
                                    <option value="driver" <?php if ($user->role == "driver") {
                                                                echo "selected";
                                                            } ?>>Driver</option>
                                </select>
                            </div>
